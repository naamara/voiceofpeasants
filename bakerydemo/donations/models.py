...
from bakerydemo.donations.choices import DAY_CHOICES
...
class DonationOperatingHours(Orderable, OperatingHours):
    """
...
class DonationsIndexPage(Page):
    ...
    def get_context(self, request):
        context = super(DonationsIndexPage, self).get_context(request)
        context['locations'] = DonationPage.objects.descendant_of(
            self).live().order_by(
            'title')
        return context
